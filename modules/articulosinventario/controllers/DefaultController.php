...
namespace app\modules\articulosinventario\controllers;
        ...
        foreach ($result as $k => $row) {
            ...
            if ($row['id_articulo'] == $id) {
                ...
                $data[] = [
                    ...
                    "entradasalida" => $row['entradasalida'],
    ...
    public function actionLista() {
        ...
        foreach ($result as $k => $row) {
            $data[] = [
                ...
                <button title="Entrada" class="btn btn-sm btn-primary font-weight-bold" onclick="funcionCrearEntrada(\''. $row["id_articulo"] .'\',\''. $row["nombre_articulo"] .'\',\''. $row["cantidad_articulo"] .'\');"><i class="fas fa-plus"></i></button>
