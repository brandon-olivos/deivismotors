...
use app\modules\articulosventas\bundles\ArticulosVentasAsset;
...
<div class="card card-custom gutter-b example example-compact">
    ...
    <form class="form" id="frm-articulo-venta">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group input-group-sm col-md-1">
                    <button type="button" class="btn btn-icon btn-primary btn-sm mt-7" id="btn_limpiar_cliente"><i class="flaticon2-plus"></i></button> 
                </div>     
            </div>
        ...
        <div class="card-footer text-right">
            ...
            <a href="<?= Yii::$app->urlManager->createUrl("articulosventas"); ?>" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
    <!--end::Form-->
</div>
