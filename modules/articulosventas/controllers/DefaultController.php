...
namespace app\modules\articulosventas\controllers;
...
class DefaultController extends Controller
{
    ...
    public function actionExportarexcel(){
        ...
        $drawing->setPath($_SERVER['DOCUMENT_ROOT'] . '/deivismotors/modules/articulosventas/assets/images/logo.jpeg');
        ...
        foreach ($data as $k => $v) {
            ...
            $sheet->setCellValue('H' . $i, $v['persona']);
    ...
    public function actionListaventas(){
        ...
        foreach ($result as $k => $row) {
            ...
            $data[] = [
                ...
                "accion" => '<a title="'. $row["comprobante"] .'" class="btn btn-sm btn-light-danger font-weight-bold mr-2" target="_blank" href="articulosventas/default/imprimir-boleta-factura/' . $row["id_articulo_venta"] . '"><i class="fas fa-file-alt"></i></a>
    ...
    public function actionImprimirBoletaFactura($id) {
        ...
        $pdf->AddPage('P', 'A4');
        $pdf->Image(Url::to('@app/modules/articulosventas/assets/images/logopegaso.png'), 10, 1, 80);
